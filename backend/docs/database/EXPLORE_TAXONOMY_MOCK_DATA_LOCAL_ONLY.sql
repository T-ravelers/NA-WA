...
-- Uses the operational_v9 taxonomy handoff dated 2026-08-06 for both Event and Place.
-- Activity IDs 1..56 and Sector IDs 1..4 are shared by both item types.
-- The handoff is a local preview source, not yet the production taxonomy authority.
...
-- Deterministic local classification only. Crawler classifications replace these links.
...
-- Map source Place kinds to representative v9 activities for local filtering.
