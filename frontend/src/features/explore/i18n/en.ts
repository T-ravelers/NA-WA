export default {
  explore: {
    ...
    areas: {
      ...
      nowon: 'Nowon',
      daehangno: 'Daehangno',
      magogGimpoAirport: 'Magok·Gimpo Airport',
      mangwon: 'Mangwon',
      mokdong: 'Mokdong',
      banpo: 'Banpo',
      bongcheonSnu: 'Bongcheon·Seoul Nat’l Univ.',
      buamPyeongchang: 'Buam·Pyeongchang',
      samSeongCoex: 'Samseong·COEX',
      sangam: 'Sangam',
      seocho: 'Seocho',
      seochon: 'Seochon',
      seongbukHansung: 'Seongbuk·Hansung Univ.',
    ...
    calendar: {
      // 달 이동·요일 문구는 공용 달력(`shared/i18n`의 `calendar`)이 갖는다.
    ...
    placeDetail: {
      ...
      shareFailed: 'We could not share this place. Please try again.',
    ...
    detail: {
      ...
      shareFailed: 'We could not share this event. Please try again.',
