export default {
  journey: {
    ...
    detail: {
      budget: 'Budget',
      itemCount: '{count} event | {count} events',
      ...
      timeline: 'Itinerary',
      spending: 'Spending',
      sectionsLabel: 'Journey detail section',
      splitExpenses: 'Split expenses',
      personCount: '{count} Person',
      distanceKm: '{distance} km',
      spendingLoading: 'Loading spending',
      spendingLoadFailed: 'Spending could not be loaded',
      spendingLoadFailedDescription: 'We could not load spending for this journey.',
      spendingEmpty: 'No spending yet',
      dayLabel: 'Day {index}',
