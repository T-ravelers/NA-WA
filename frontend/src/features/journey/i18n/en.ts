export default {
  journey: {
    ...
    invite: {
      ...
      linkUnavailable: 'This device cannot copy the link. Read out the invite code instead.',
      hint: 'Anyone with this link can see the journey. Joining a journey is not open yet.',
      qrTitle: 'Invite QR',
      qrImageLabel: 'QR code for the invite link',
      qrFailed: 'The QR code could not be drawn. Use the invite link instead.',
      done: 'Done',
      loadFailed: 'Invite could not be loaded',
    },
    settings: {
      ...
      name: 'Journey name',
      budget: 'Budget',
      budgetHelper: 'Optional. Leave empty to track spending without a cap. 1 P = ₩1.',
      companions: 'Who travels?',
      save: 'Save changes',
