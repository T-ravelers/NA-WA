  ...
  report: {
    ...
    detail: {
      ...
      sharing: {
        ...
        summaryPlain: '{journey} ({period}) — travel report.',
      ...
      comparison: {
        ...
        similarEmptyDescription: 'Travelers with the same nationality and a report show up here.',
    ...
    errorCode: {
      ...
      'REPORT-005': 'A report already exists for this journey.',
