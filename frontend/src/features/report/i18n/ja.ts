...
export default {
  report: {
    list: {
      title: 'レポート',
      description: '終了した旅程を選んで、レポートを作成または表示します。',
      loadFailed: 'レポートを読み込めませんでした。もう一度お試しください。',
      emptyTitle: '終了した旅程はまだありません',
      emptyDescription: 'レポートは旅程の終了後に作成できます。',
      ended: '終了',
    ...
    detail: {
      ...
      sharing: {
        ...
        summaryPlain: '{journey}（{period}）— 旅行レポート。',
        copiedReport: 'レポートの文面をコピーしました。',
        copiedTicket: 'チケットの文面をコピーしました。',
        copyFailed: '文面をコピーできませんでした。もう一度お試しください。',
      ...
      comparison: {
        ...
        similarEmptyDescription: '同じ国籍でレポートを持つ旅行者がここに表示されます。',
